        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                function onFinishCallback() {
                    ...
                    jQuery.ajax({
                        type: 'POST',
                        url: 'controller/ouvintes.php',
                        data: {n: nome, p: pai, ma: mae, g: genero, idp: idProv, dataN: dataNasc, fot: foto, tipo: tipoS,b: BI},
                        beforeSend: function () {

                        },
                        success: function (dados) {
                            if (dados.trim() === 'sucess') {
                                jQuery('#notif').html('<h4 class="widgettitle title-success">Utilizador cadastrado com sucesso</h4>').show(200).delay(5000).hide(200);
                                return false;
                            } else if (dados.trim() === 'empt') {
                                jQuery('#notif').html('<h4 class="widgettitle title-danger">Erro no cadastro do utilizador</h4>').show(200).delay(5000).hide(200);
                                return false;
                            }
                            return false;
                        },
        ...
        <div class="mainwrapper">
            ...
            <div class="rightpanel">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li>BDgenesis / Cadastrar Ouvintes /</li>
                         ...
                         <br> <div id="notif">
                            ...
                            <form class="stdform" method="Post" action="">
                                <div id="wizard" class="wizard"  >
                                    ...
                                    <ul class="hormenu anchor" style="margin-bottom: 3px;background:#042a71;color: #fff;"><br><br><center><h2 class="subtitle1">Cadastrar Ouvintes da Igreja</h2></center>
                                        <li>
  ...
  <br>  <br>
                                    <div class="stepContainer" style="height: 237px;border: none"><div  id="wiz1step1" class="formwiz content" style="display: block;">
                                            ...
                                            <p>
                                                ...
                                                <span class="field"><input type="text" id="dataNasc" class="input-xxlarge"></span>
                                            </p>
                                           ...
                                           <p>
                                                ...
                                                <span style="margin-left:30px;"> <b>Nº Telefone </b>:&nbsp;&nbsp;<input type="text" placeholder="+255" id="livroN"class="input-medium form-inline"></span>
                                            ...
                                            <p>
                                                ...
                                                <span class="field"><input type="date"id="phone" class="input-xxlarge"></span>
                                            </p>
                                            <p>
                                                <label>Foto</label>
                                                <span class="field"><input type="file"id="phone" class="input-xxlarge"></span>
                                            </p>
                                        ...
                                        <div id="wiz1step2"  class="formwiz content" style="display: none;">
                                            ...
                                            <p>
                                                ...
                                                <span class="field"><input type="text" id="user" class="input-xxlarge"></span>
                                            </p>
                                           
                                             <p>
                                                <label>Residente</label>
                                                <span class="field"><input type="password" id="pass" class="input-xxlarge form-inline"></span>
                                            
                                            </p>
                                               <p>
                                                <label>Função na Igreja</label>
                                                <span class="field"><select class="input-xlarge">
                                                               <option>---------</option>
                                        ...
                                        <div id="wiz1step3" class="content" style="display: none;">
                                            ...
                                            <div class="par terms" style="padding: 0 20px;">
                                                ...
                                                <p class="text-center"><img src="images/v.png"></p>
                                                    </div>
                                                </span>
                                            </p>
                                            </div>
