        ...
        <div class="mainwrapper">
            ...
            <div class="rightpanel">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li>Administração / Baptizar Membro / </li>
				...
				<div id="notif"></div>
                            <h4 class="widgettitle"><i class="iconfa-print"></i>&nbsp;&nbsp;&nbsp;BAPTIZAR MEMBROS</h4>
                                ...
                                <form class="stdform stdform2" method="post" action="" id="frm_horario" name="frm_horario">
                                    <p>
                                        ...
                                        <span class="field">
                                            ...
                                            <select class="select2"name="ouvintes" id="ouvintes"style="width: 100%;">
                                    ...
                                    <p>
                                       ...
                                       <!--PRINVICIA-->
                                        ...
                                        <select name="selection" id="curso" class="input-medium">
                                                <option value="Informática">Namibe</option>
                                        </select>
                                        <!--MINICIPIO-->
                                     
                                           &nbsp;&nbsp; &nbsp;&nbsp;<strong>Município: </strong>
						
						</strong> <select name="classe" id="classe" class="input-medium">
                                                <option value="10a">Moçamendes</option>
                                            ...
                                            <select name="classe" id="classe" class="input-medium">
                                                <option value="10a">Saco-Mar</option>
                                            </select>
                                    ...
                                    <p> 
                                        <label>Sobre o Baptismo <small>Informenos dados como nome da Congregação o nome do Pastor para ser processado a sua CERTIDÃO DE BAPTISMO</small></label>
                                       <span class="field">
                                           &nbsp;&nbsp; <strong> Congregação:</strong> 
                                           <select name="selection" id="dia" class="input-medium">
                                                <option value="Segunda">Segunda</option>
                                                <option value="Terça">Ter&ccedil;a</option>
                                            ...
                                            <input type="date" >
                                            &nbsp;&nbsp;
                                            <strong> Livro Nº: </strong> 
                                            <input type="number" style="width:40px;">
                                            &nbsp;&nbsp;<strong> Registro Nº: </strong>
                                            <input type="number" disabled="" style="width:40px;">


                                    </p>

                                    <p >
                                    <center><strong>PASTOR: </strong><BR>
                                        <input type="text" style="color: red">
                                       </center>
                                    </p>
                                    <p class="stdformbutton">
                                   <button class="btn btn-primary">Baptizar</button>
